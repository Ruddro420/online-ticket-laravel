...
<body style="background: white!important" class="antialiased bg-white">
    <div
        ...
        <center>
            <h1 style="font-size: 30px;margin-bttom:100px">WELCOME TO STOREKEEPER</h1><br><br><br>
            @if (Route::has('login'))
            <div class="">
                @auth
                <a href="{{ url('/dashboard') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                @else
                <a style="background:black;padding:20px;color:white;margin:10px" href="{{ route('login') }}"
                    class="">Login</a>

                @if (Route::has('register'))
                <a style="background:black;padding:20px;color:white;margin:10px"
