            ...
            <form action="{{route('ticket.check')}}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-5">
                    ...
                    <div class="relative">
                        <select
                            ...
                            id="grid-state" name="form" required>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        type="text" value="Cox's Bazaar" disabled name="to" required>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                        Journey Date
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="number" name="seat" placeholder="2" required>
                </div>
                <div class="flex items-center justify-between">
                    ...
                    @if(session('status') == 'Seat available! You can book now.')
                    <button
                        class="bg-red-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                        type="submit">
                        Book Now
                    </button>
                    @endif
