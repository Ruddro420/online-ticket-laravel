...
Route::get('/checkTicket', [TicketController::class, 'checkTicket'])->name('ticket.check.number');
Route::get('/searchTicket', [TicketController::class, 'searchTicket'])->name('ticket.search');
